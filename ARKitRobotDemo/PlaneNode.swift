...
//  ARKitRobotDemo
//
//  Created by Alexey on 5/10/23.
//  Copyright © 2023 mogauk. All rights reserved.
//
...
class PlaneNode: SCNNode {
    ...
    init(anchor: ARPlaneAnchor) {
        ...
        self.plane.materials.first?.diffuse.contents = UIColor(red: 90/255, green: 200/255, blue: 250/255, alpha: 0.70)
